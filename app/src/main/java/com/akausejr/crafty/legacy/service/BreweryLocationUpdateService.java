package com.akausejr.crafty.legacy.service;
...
import com.akausejr.crafty.legacy.provider.BreweryLocationContract;
import com.akausejr.crafty.legacy.provider.CraftyContentProvider;
        ...
        if (activeNetwork == null || !activeNetwork.isConnectedOrConnecting()) {
            ...
            if (intent.getBooleanExtra(EXTRA_FORCED, false) ||
                ...
                try {
                    ...
                    Log.w(TAG, "Locations update failed");
                    e.printStackTrace();
                }
            }
        }
